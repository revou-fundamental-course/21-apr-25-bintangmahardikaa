...
function updateModeUI() {
    ...
    if (isReversed) {
      ...
      cInput.placeholder = 'Hasil dalam Celsius akan muncul di sini';
      fInput.placeholder = 'Masukkan suhu dalam Fahrenheit';
    } else {
      cInput.readOnly = false;
      fInput.readOnly = true;
      convertBtn.textContent = 'Konversi ke °F';
      cInput.placeholder = 'Masukkan suhu dalam Celsius';
      fInput.placeholder = 'Hasil dalam Fahrenheit akan muncul di sini';
    }
  }
